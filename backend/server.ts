...
const allowedOrigins = process.env.FRONTEND_URL
  ? [process.env.FRONTEND_URL,"https://www.travellocal.online", "http://localhost:5173", "http://localhost:5174"]
  : ["https://www.travellocal.online", "http://localhost:5173", "http://localhost:5174"];
